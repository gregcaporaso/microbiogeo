...
from python.qiime.stats import Mantel, MantelCorrelogram, PartialMantel
...
script_info['optional_options'] = [
    ...
    make_option('-c', '--control_dm',
        help='the control matrix. Only applies (and is *required* when method '
        'is partial_mantel. [default: %default]', default=None,
