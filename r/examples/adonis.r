# Runs vegan function ADONIS on QIIME distance file.
# usage:
# R --slave --args -d unifrac.txt -m Fasting_Map.txt -c Treatment -o adonis < adonis.r
# 
# print help string:
# R --slave --args -h < adonis.r
#
...
# run adonis
results <- adonis(formula = as.dist(qiime.data$distmat) ~ qiime.data$map[[opts$category]])
