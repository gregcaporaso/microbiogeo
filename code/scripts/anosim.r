# Runs vegan function anosim on QIIME distance matrix
# usage:
# R --slave --args --source_dir $QIIME_HOME/qiime/support_files/R/ -d unifrac.txt -m Fasting_Map.txt -c Treatment -o anosim < anosim.r
#
# print help string:
...
# run anosim
results <- anosim(dat=as.dist(qiime.data$distmat),
                  grouping=qiime.data$map[[opts$category]],
