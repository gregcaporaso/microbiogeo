...
#Angélique Gobet, Alban Ramette, August 2011
#Version 1.3
...
#The data can then be stored into the object M in the workspace  :
...
#Load and run the scripts: community structure
...
#
#-	To export the tables as text files (can be useful for further use under ecel, for instance)
#
...
#3.2.	Application of successive cutoffs on each original matrices
